...
/* Identities are not served from here: the chain-wide ERC-8004 registry is no
   longer indexed (see ponder.config.ts), and the agent service is the source
   for our own agents' ids. */
